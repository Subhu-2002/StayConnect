...
import com.example.stayconnect.databinding.RowServicesCategoryBinding;
...
public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.HolderCategory>{
    ...
    private RowServicesCategoryBinding binding;
    ...
    public HolderCategory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding = RowServicesCategoryBinding.inflate(LayoutInflater.from(context), parent, false);
